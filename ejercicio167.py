...
We have the following y_true list with classes from the test set and the
following y_pred list with classes provided by the model:
y_true = [0, 0, 1, 1, 0, 1, 0]
y_pred = [0, 0, 1, 0, 0, 1, 0]
Our task is to implement a function called accuracy(), which takes two
arguments y_true, y_pred and calculates the accuracy of our model.
